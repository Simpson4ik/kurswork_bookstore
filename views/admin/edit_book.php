...
<form id="edit-book-form" data-book-id="<?php echo htmlspecialchars($book['book_id']); ?>" style="max-width: 500px; margin: 0 auto;">
    <div>
    ...
    <div>
        ...
        <input type="number" id="stock_quantity" name="stock_quantity" value="<?php echo htmlspecialchars($book['stock_quantity']); ?>" required>
    </div>
    <div>
        <label>Поточна обкладинка:</label>
        <br>
        <?php if (!empty($book['cover_image'])): ?>
            <img src="<?php echo defined('BASE_PATH') ? BASE_PATH : ''; ?>/public/uploads/<?php echo $book['cover_image']; ?>" alt="Обкладинка" style="max-width: 140px; border-radius: 8px; margin-bottom: 12px; display: block; border: 1px solid var(--border);">
        <?php else: ?>
    ...
    <div style="margin-bottom: 20px;">
        ...
        <div class="dropdown-search-wrapper">
            ...
            <input type="hidden" id="publisher_id" name="publisher_id" value="<?php echo htmlspecialchars($book['publisher_id']); ?>">
        ...
        <div class="dropdown-search-wrapper">
            ...
            <div id="authors-checkbox-container" class="dropdown-search-list">
                <?php foreach ($authors as $author): ?>
                    ...
                    ?>
                    <label>
                        <input type="checkbox" name="authors[]" value="<?php echo htmlspecialchars($author['author_id']); ?>" class="author-item-checkbox" data-name="<?php echo htmlspecialchars($fullName); ?>" <?php echo $isChecked; ?>>
        ...
        <div class="dropdown-search-wrapper">
            ...
            <div id="genres-checkbox-container" class="dropdown-search-list">
                <?php foreach ($genres as $genre): ?>
                    ...
                    <label>
                        <input type="checkbox" name="genres[]" value="<?php echo htmlspecialchars($genre['genre_id']); ?>" class="genre-item-checkbox" data-name="<?php echo htmlspecialchars($genre['genre_name']); ?>" <?php echo $isChecked; ?>>
...
<p><a href="<?php echo defined('BASE_PATH') ? BASE_PATH : ''; ?>/admin/dashboard">Повернутися в admin-панель</a></p>